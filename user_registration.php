...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO users (name, username, password, email, gender, contact, age, city, country) VALUES ('$name', '$username', '$password', '$email', '$gender', '$contact', '$age', '$city', '$country')";
...
<body>
    <div class="navbar">
        ...
        <a href="user_registration.php" class="right">Sign Up</a>
    </div>
    <div class="container">
        <h1>User Sign Up</h1>
